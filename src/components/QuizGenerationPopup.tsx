...
function CustomDropdown({ 
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-20 bottom-full mb-1 w-full bg-gray-800/95 backdrop-blur-sm rounded-lg border-0 shadow-[0_0_0_1px_rgba(99,102,241,0.2),0_4px_20px_rgba(0,0,0,0.3)] max-h-48 overflow-y-auto">
          <div className="py-1">
            {options.map((option) => (
              <button
                key={option}
...
export default function QuizGenerationPopup({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div onClick={(e) => e.stopPropagation()} className="bg-gradient-to-br from-gray-800/90 to-gray-900/95 rounded-xl shadow-2xl border border-gray-700/50 w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-700/50">
          ...
          <button 
            onClick={onCancel}
            className="text-gray-400 hover:text-white transition-colors rounded-full p-1 hover:bg-gray-700/50"
          >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="mb-6 space-y-3">
                ...
                <label className={`flex items-start p-3 rounded-lg ${selectionType === 'specific-masechta' ? 'bg-indigo-500/10 shadow-[0_0_0_1px_rgba(99,102,241,0.4)]' : 'bg-gray-700/30 hover:bg-gray-700/40 shadow-[0_0_0_1px_rgba(75,85,99,0.2)]'} cursor-pointer transition-all border-0`}>
                  ...
                  <div className="ml-3">
                    ...
                    <span className="text-gray-300 text-sm">Test on a specific tractate</span>
                  </div>
                </label>
                ...
                <label className={`flex items-start p-3 rounded-lg ${selectionType === 'all-learned' ? 'bg-indigo-500/10 shadow-[0_0_0_1px_rgba(99,102,241,0.4)]' : 'bg-gray-700/30 hover:bg-gray-700/40 shadow-[0_0_0_1px_rgba(75,85,99,0.2)]'} cursor-pointer transition-all border-0`}>
                  ...
                  <div className="ml-3">
                    ...
                    <span className="text-gray-300 text-sm">Test on everything you've learned</span>
                  </div>
                </label>
                ...
                <label className={`flex items-start p-3 rounded-lg ${selectionType === 'by-topic' ? 'bg-indigo-500/10 shadow-[0_0_0_1px_rgba(99,102,241,0.4)]' : 'bg-gray-700/30 hover:bg-gray-700/40 shadow-[0_0_0_1px_rgba(75,85,99,0.2)]'} cursor-pointer transition-all border-0`}>
                  ...
                  <div className="ml-3">
                    ...
                    <span className="text-gray-300 text-sm">Test on a specific topic across your learning</span>
                  </div>
                </label>
              </div>
              ...
              <div className="sticky bottom-0 mt-6 pt-4 flex gap-3 bg-gradient-to-t from-gray-800 via-gray-800 to-transparent">
                <button
                  onClick={onCancel}
                  className="flex-1 py-2.5 px-4 bg-gray-700/50 hover:bg-gray-600/60 rounded-lg text-gray-300 transition-all border-0 hover:text-gray-100"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-grow py-2.5 px-4 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 rounded-lg text-white font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center border-0 shadow-lg hover:shadow-[0_0_15px_rgba(99,102,241,0.4)] transform hover:-translate-y-0.5"
                >
